    ...
    newrowtop.setAttribute("class", "row bg-primary");
    ...
    newhead.innerHTML = "BOOK";
    newhead.setAttribute("class", "font text-center text-dark dark ms-2")
...
async function ApiCall () { 
    ...
    newh1.setAttribute("class","card-header bg-dark text-white rounded-1")
